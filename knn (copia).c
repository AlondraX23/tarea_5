...
double promedioX(xyc *arrClase0, xyc *arrClase1, double *x, int linasConDatos, int cantidadDatosEnClase)
{
    int a = 0;
    double distancia;
    for (int i = 0; i < cantidadDatosEnClase; i++) // CLASE 0
    {
        x[a] = arrClase0[i].x;
        a++;
    }
    ...
    int b = -1;
    for (int i = cantidadDatosEnClase; i < linasConDatos; i++) // CLASE 1
    {
        b++;
        x[a] = arrClase0[i].x;
        a++;
    ...
    for (int i = 0; i < linasConDatos - 1; i++)
    {
    }
}

double sumaX(xyc *arrClase0, xyc *arrClase1, double x)
{
}
...
int main()
{
    ...
    double x[linasConDatos];

    // double promedioX(arrClase0, arrClase1, x, linasConDatos, cantidadDatosEnClase);

    // double sumaX(arrClase0, arrClase1, x);
